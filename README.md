...
https://viblo.asia/p/nestjs-framework-than-thanh-cho-nodejs-RQqKLL7OK7z

### document

- create new project: nest new rest-api
...
- cd src/posts
- nest generate interface posts => define PostModel
- cd ../..
- nest generate service posts => PostsService
- nest generate controller posts => PostsController
